...
(1, 'Administrasi Perencanaan', 3, 'F1_03', 'Program Semester'),
(1, 'Administrasi Perencanaan', 4, 'F1_04', 'Silabus (Khusus untuk kelas 12)'),
(1, 'Administrasi Perencanaan', 5, 'F1_05', 'Rencana Pelaksanaan Pembelajaran/Modul Ajar'),
(1, 'Administrasi Perencanaan', 6, 'F1_06', 'Jadwal Tatap Muka'),
(1, 'Administrasi Perencanaan', 7, 'F1_07', 'Agenda Harian'),
(1, 'Administrasi Perencanaan', 8, 'F1_08', 'Daftar Nilai (Sikap, Pengetahuan, dan Keterampilan)'),
(1, 'Administrasi Perencanaan', 9, 'F1_09', 'Kriteria Ketuntasan Minimal'),
...
(2, 'Komponen Modul/RPP', 3, 'F2_03', 'Alur Tujuan Pembelajaran'),
(2, 'Komponen Modul/RPP', 4, 'F2_04', 'Indikator Ketercapaian Tujuan Pembelajaran'),
(2, 'Komponen Modul/RPP', 5, 'F2_05', 'Tujuan Pembelajaran'),
(2, 'Komponen Modul/RPP', 6, 'F2_06', 'Materi Pembelajaran'),
(2, 'Komponen Modul/RPP', 7, 'F2_07', 'Pendekatan, Model, dan Metode'),
(2, 'Komponen Modul/RPP', 8, 'F2_08a', 'Kegiatan Pembelajaran - Pendahuluan'),
(2, 'Komponen Modul/RPP', 9, 'F2_08b', 'Kegiatan Pembelajaran - Kegiatan inti'),
(2, 'Komponen Modul/RPP', 10, 'F2_08c', 'Kegiatan Pembelajaran - Penutup'),
(2, 'Komponen Modul/RPP', 11, 'F2_09a', 'Penilaian Pembelajaran, Remedial, dan Pengayaan - Teknik penilaian'),
(2, 'Komponen Modul/RPP', 12, 'F2_09b', 'Penilaian Pembelajaran, Remedial, dan Pengayaan - Instrumen penilaian'),
(2, 'Komponen Modul/RPP', 13, 'F2_09c', 'Penilaian Pembelajaran, Remedial, dan Pengayaan - Pembelajaran, remedial, dan pengayaan'),
...
(4, 'Instrumen Penilaian', 3, 'F4_02b', 'Melakukan Tes - Penilaian Tengah Semester (PTS)'),
(4, 'Instrumen Penilaian', 4, 'F4_02c', 'Melakukan Tes - Penilaian Akhir Semester (PAS)'),
(4, 'Instrumen Penilaian', 5, 'F4_02d', 'Melakukan Tes - Penilaian Akhir Tahun (PAT)'),
(4, 'Instrumen Penilaian', 6, 'F4_03a', 'Penilaian Pengetahuan - Tes tulis'),
(4, 'Instrumen Penilaian', 7, 'F4_03b', 'Penilaian Pengetahuan - Tes lisan'),
(4, 'Instrumen Penilaian', 8, 'F4_03c', 'Penilaian Pengetahuan - Penugasan'),
(4, 'Instrumen Penilaian', 9, 'F4_03d', 'Penilaian Pengetahuan - Pengolahan Nilai Pengetahuan'),
(4, 'Instrumen Penilaian', 10, 'F4_03e', 'Penilaian Pengetahuan - Deskripsi Nilai Pengetahuan'),
(4, 'Instrumen Penilaian', 11, 'F4_04a', 'Penilaian Keterampilan - Unjuk kerja/praktik/kinerja/projek/produk/portofolio'),
(4, 'Instrumen Penilaian', 12, 'F4_04b', 'Penilaian Keterampilan - Pengolahan Nilai Keterampilan'),
(4, 'Instrumen Penilaian', 13, 'F4_04c', 'Penilaian Keterampilan - Deskripsi Nilai Keterampilan'),
(4, 'Instrumen Penilaian', 14, 'F4_05a', 'Penilaian Sikap - Observasi/penilaian diri/penilaian antar peserta didik'),
(4, 'Instrumen Penilaian', 15, 'F4_05b', 'Penilaian Sikap - Pengolahan Nilai Sikap'),
(4, 'Instrumen Penilaian', 16, 'F4_05c', 'Penilaian Sikap - Deskripsi Nilai Sikap'),
(4, 'Instrumen Penilaian', 17, 'F4_06', 'Remedial'),
